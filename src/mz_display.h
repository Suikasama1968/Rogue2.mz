...
#define DC_TRIANGLE_1     0x42    // △
#define DC_TRIANGLE_2     0x4d    // △
#define DC_TRIANGLE_3     0x4e    // △
#define DC_TRIANGLE_4     0x56    // △
#define DC_SQUARE         0x43    // ■
#define DC_PIPE           0x35    // |
#define DC_D_BAR          0x3a    // _
#define DC_U_BAR          0x7a    // ~
...
#define DC_END            0xff    // TEXT_Write用文字列終端

// テキストアトリビュート
#define DC_CSET_0       0x0000
#define DC_CSET_1       0x8000

// 前面カラー
#define DC_FG_BLACK    0x0000    // 黒
#define DC_FG_BLUE     0x1000    // 青
#define DC_FG_RED      0x2000    // 赤
#define DC_FG_MAGENTA  0x3000    // マゼンタ
#define DC_FG_GREEN    0x4000    // 緑
#define DC_FG_CYAN     0x5000    // シアン
#define DC_FG_YELLOW   0x6000    // 黄色
#define DC_FG_WHITE    0x7000    // 白

// 背面カラー
#define DC_BG_BLACK    0x0000    // 黒
#define DC_BG_BLUE     0x0100    // 青
#define DC_BG_RED      0x0200    // 赤
#define DC_BG_MAGENTA  0x0300    // マゼンタ
#define DC_BG_GREEN    0x0400    // 緑
#define DC_BG_CYAN     0x0500    // シアン
#define DC_BG_YELLOW   0x0600    // 黄色
#define DC_BG_WHITE    0x0700    // 白

// VRAM関連定義
#define ATTR_OFFSET 0x0800
#define TEXT_VRAM   0xd000
#define TEXT_ATTR   0xd800
#define PCG_VRAM    0xd400
#define PCG_ATTR    0xdc00

// 仮想VRAM関係定義 80x25
#define TEXT_V_VRAM         0xc000
#define TEXT_V_ATTR         0xc800
#define V_ATTR_OFFSET       0x0800
#define V_COLUMN        80
#define V_ROW           25

// PCG BLOCK NUMBER & CHECK MACRO
#define PCG_CLEAR       0x00
#define PCG_BLOCK1      0x08
#define PCG_BLOCK2      0x48
#define PCG_BLOCK3      0x88
